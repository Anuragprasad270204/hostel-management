...
function CompleteProfileForm() {
  ...
  useEffect(() => {
    const fetchHostels = async () => {
      try {
        ...
        setError(
          err.message || "Failed to load hostels for form. Please log in again."
        );
      } finally {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        "http://hostel-management-3x2z.onrender.com/api/student-profiles",
        {
          method: "POST",
          headers: {
      ...
      setError(
        err.message || "Failed to complete profile. Please check input."
      );
    }
  };
        ...
        <div className="card-body">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="row g-3">
              ...
              <div className="col-md-6">
                <label htmlFor="hostelId" className="form-label">
                  Assigned Hostel:
                </label>
                <select
                  id="hostelId"
              ...
              <div className="col-md-4">
                <label htmlFor="ec_name" className="form-label">
                  Name
                </label>
                <input
                  type="text"
              ...
              <div className="col-md-4">
                <label htmlFor="ec_relation" className="form-label">
                  Relation
                </label>
                <input
                  type="text"
              ...
              <div className="col-md-4">
                <label htmlFor="ec_phone" className="form-label">
                  Phone
                </label>
                <input
                  type="text"
